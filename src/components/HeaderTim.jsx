  ...
  return (
    ...
    <div className="container-fluid position-relative p-0">
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="/tim" className="nav-item nav-link active">Developer</a>
            </div>
        </div>
        </nav>
        <div className="container-fluid bg-primary py-5 mb-5 hero-tim">
        <div className="container py-5">
            <div className="row justify-content-center py-5">
            <div className="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                <h1 className="display-3 text-white mb-3 animated slideInDown"> Developer Ganteng Kami</h1>
                <p className="fs-4 text-white mb-4 animated slideInDown">Tim kami melayani dengan sepenuh hati</p>
            </div>
            </div>
        </div>
        </div>
